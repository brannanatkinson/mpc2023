    ...
    @can('admin')
        ...
        <div class="my-8 text-center">
            <ul class="inline-block">
                ...
                <li class="inline-block"><a href="/admin/hosts"><button class="px-4 py-3 rounded-md bg-mp-blue-green hover:bg-mp-light-lime text-xl text-white font-bolder">Manage Hosts</button></a></li>
            </ul>
        </div>
                ...
                @foreach ( $gift_items as $item )
                    <div class="bg-white text-center flex flex-col rounded-md overflow-hidden">
                        ...
                        <div class="mb-4 text-3xl">
                            {{ App\Models\Item::where('statamic_id', $item->id)->first()->sales()->quantity() }}
                        </div>
